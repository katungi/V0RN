    ...
    <div className="flex flex-col md:flex-row h-screen bg-white">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <DialogTrigger asChild>
                    <Button variant="ghost" size="icon" className="hover:border-teal-400 hover:border-2 transition-colors">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">What can I help you ship today?</h1>
          <p className="text-gray-600 mb-8 text-center">Generate UI, ask questions, debug, execute code, and much more.</p>
